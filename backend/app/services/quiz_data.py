...
# ═══════════════════════════════════════════════════════════════
# 240 HARDCODED MULTIPLE-CHOICE QUESTIONS (20 per Level, 12 Levels total)
# ═══════════════════════════════════════════════════════════════
...
QUIZ_QUESTIONS: list[dict] = [
    ...
    },
    {
        "id": 175,
        "level": 9,
        "question": "Beta ($eta$) stock evaluation mein kya naapta hai?",
        "options": {
    ...
    },
    {
        "id": 201,
        "level": 82,
        "question": "Gold ki pricing unit Pakistan mein aam tor par kya hoti hai?",
        "options": {
            "a": "Ounce",
            "b": "Tola",
            "c": "Gram",
        ...
        "correct_option": "b",
        "explanation": "Pakistan mein gold ka rate aam tor par per Tola (11.66 grams) ke hisab se bataya aur trade kiya jata hai."
    },
    {
        "id": 202,
        "level": 82,
        "question": "1 Tola gold mein taqreeban kitne grams hote hain?",
        "options": {
            "a": "10 grams",
            "b": "11.66 grams",
            "c": "12.5 grams",
        ...
        "correct_option": "b",
        "explanation": "1 Tola standard measurement ke mutabiq 11.66 grams ke barabar hota hai."
    },
    {
        "id": 203,
        "level": 82,
        "question": "Gold ko safe-haven asset kyun samjha jata hai?",
        "options": {
            "a": "Kyunke iska rate kabhi change nahi hota",
            "b": "Kyunke devalue hoti currency aur inflation ke doran ye apni value barkarar rakhta hai",
            "c": "Kyunke bank ispar monthly fixed profit dete hain",
            "d": "Kyunke isme koi risk nahi hota"
        },
        "correct_option": "b",
        "explanation": "High inflation aur currency devaluation ke doran gold ki qeemat barh jati hai, jis se sarmayakaron ki purchasing power mehfooz rehti hai."
    },
    {
        "id": 204,
        "level": 82,
        "question": "Gold ki purity (khalispan) kis unit mein measure ki jati hai?",
        "options": {
            "a": "Karat (K)",
            "b": "Gram",
            "c": "Litre",
        ...
        "correct_option": "a",
        "explanation": "Gold ki purity Karat (jaise 24K, 22K, 18K) mein check ki jati hai."
    },
    {
        "id": 205,
        "level": 82,
        "question": "24 Karat gold ka kya matlab hai?",
        "options": {
            "a": "Gold mein 50% milaawat hai",
            "b": "99.9% خالص (Pure) gold jis mein koi milaawat nahi hoti",
            "c": "Jewelry banane ke liye behtareen gold",
            "d": "Sarkari gold"
        },
        "correct_option": "b",
        "explanation": "24 Karat gold sabse khalis gold hota hai (99.9% pure). Ye narm hota hai isliye iski jewelry aam tor par nahi banti."
    },
    {
        "id": 206,
        "level": 82,
        "question": "Real Estate (Zameen/Makaan) se monthly passive income haasil karne ka zariya kya hai?",
        "options": {
            "a": "Capital gain",
            "b": "Rental Yield (Kiraya)",
            "c": "Stock dividends",
            "d": "Bank interest"
        },
        "correct_option": "b",
        "explanation": "Property ko lease/kiraye par dekar jo monthly rental income milti hai use Rental Yield kehte hain."
    },
    {
        "id": 207,
        "level": 82,
        "question": "REITs (Real Estate Investment Trusts) ka kya faida hai?",
        "options": {
            "a": "Ye bina physical property khareede real estate market mein sarmayakari ka zariya hain",
            "b": "Ye property tax khatam kar dete hain",
            "c": "Ye sirf government employees ke liye hain",
            "d": "In mein koi risk nahi hota"
        },
        "correct_option": "a",
        "explanation": "REITs shares ki tarah trade hote hain jo commercial/residential real estate projects mein choti investment ki ijazat deta hai."
    },
    {
        "id": 208,
        "level": 82,
        "question": "Pakistan mein REITs ko kaun sa idara regulate karta hai?",
        "options": {
            "a": "FBR",
            "b": "SECP (Securities and Exchange Commission of Pakistan)",
            "c": "State Bank of Pakistan",
            "d": "LDA / CDA"
        },
        "correct_option": "b",
        "explanation": "SECP Pakistan mein tamam corporate investments, mutual funds aur REITs ko regulate karta hai."
    },
    {
        "id": 209,
        "level": 82,
        "question": "Property market mein Capital Appreciation ka kya matlab hai?",
        "options": {
            "a": "Property par tax barhna",
            "b": "Zameen ya ghar ki market value ka waqt ke sath barhna",
            "c": "Kiraye ka har saal barhna",
            "d": "Property ki repair ka kharcha"
        },
        "correct_option": "b",
        "explanation": "Waqt ke sath zameen ya building ki market price barhne ko Capital Appreciation kehte hain."
    },
    {
        "id": 210,
        "level": 82,
        "question": "Gold coins aur bars khareedna jewelry ke muqable mein kyun behtar sarmayakari hai?",
        "options": {
            "a": "Kyunke inka color behtar hota hai",
            "b": "Kyunke in par making charges (katai/mazdoori) aur tax nihayat kam hote hain",
            "c": "Kyunke in par zakat nahi hoti",
            "d": "Kyunke inki chori ka khatra nahi hota"
        },
        "correct_option": "b",
        "explanation": "Jewelry par heavy making charges lagte hain jo bechte waqt zaya ho jate hain. Bullion (coins/bars) sarmayakari ke liye behtar hain."
    },
    {
        "id": 211,
        "level": 82,
        "question": "Property ki khareed-o-ferokht mein Filer aur Non-Filer tax rate mein kya farq hai?",
        "options": {
            "a": "Dono ka tax barabar hota hai",
            "b": "Non-Filer par Filer se dugna ya us se bhi zyada withholding/registration tax lagta hai",
            "c": "Non-Filer par koi tax nahi hota",
            "d": "Filer ko 100% tax chhoot milti hai"
        },
        "correct_option": "b",
        "explanation": "FBR regulations ke mutabiq non-filers ko property transactions par penalty tax dena hota hai jo ke filers se kain zyada hai."
    },
    {
        "id": 212,
        "level": 82,
        "question": "Pakistan mein Unapproved housing schemes mein file system (Plot Files) khareedne ka sab se bora risk kya hai?",
        "options": {
            "a": "Tax rate barh jana",
            "b": "Possession (qabza) na milna aur scheme ka illegal hona",
            "c": "Gold rate ka gir jana",
            "d": "Kiraye ka na milna"
        },
        "correct_option": "b",
        "explanation": "Unapproved schemes aam tor par file bech deti hain lekin physical zameen majood nahi hoti, jo sarmayakar ke nuqsaan ka sabab banta hai."
    },
    {
        "id": 213,
        "level": 82,
        "question": "Real Estate ki liquidity (kash mein badalne ki salahiyat) stock market se kaisi hoti hai?",
        "options": {
            "a": "Bohot fast hoti hai",
            "b": "Bohot slow aur low liquidity hoti hai (property bechne mein mahino lag sakte hain)",
            "c": "Dono barabar hain",
            "d": "Real estate ko cash mein nahi badla ja sakta"
        },
        "correct_option": "b",
        "explanation": "Real estate highly illiquid asset hai kyunke aap plot ya ghar ko fori tor par nahi bech sakte, jabke stocks minutes mein beche ja sakte hain."
    },
    {
        "id": 214,
        "level": 82,
        "question": "Pakistan mein local gold rate kis cheez par depend karta hai?",
        "options": {
            "a": "Sirf local demand par",
            "b": "International gold rate (USD per ounce) aur USD-PKR exchange rate par",
            "c": "KSE-100 index par",
            "d": "FBR tax policies par"
        },
        "correct_option": "b",
        "explanation": "Gold rate international market aur dollar ki rate tabdeeli ke tehat Pakistan mein har din adjust hota hai."
    },
    {
        "id": 215,
        "level": 82,
        "question": "Rental Yield nikalne ka kya formula hai?",
        "options": {
            "a": "(Saalana Rent / Property Qeemat) * 100",
            "b": "Monthly Rent * 12",
            "c": "Property Qeemat - Total Taxes",
            "d": "Rent + Capital Appreciation"
        },
        "correct_option": "a",
        "explanation": "Rental yield percentage mein hoti hai jo saalana kiraye ko property ki total value se divide aur 100 se multiply karke nikalti hai."
    },
    {
        "id": 216,
        "level": 82,
        "question": "Agar ek plot 50 lakh ka khareed kar 70 lakh ka becha jaye, to is 20 lakh ke profit ko financial terms mein kya kehte hain?",
        "options": {
            "a": "Dividend",
            "b": "Capital Gain (سرمائے ka munafa)",
            "c": "Yield",
            "d": "Bonus"
        },
        "correct_option": "b",
        "explanation": "Kisi sarmayakar ko asset value barhne aur use bechne par jo profit milta hai use Capital Gain kehte hain."
    },
    {
        "id": 217,
        "level": 82,
        "question": "Pakistan Mercantile Exchange (PMEX) ke zariye gold khareedne ka kya faida hai?",
        "options": {
            "a": "Ye physical gold ki chori ke risk ke baghair digital gold trading ki sahulat deta hai",
            "b": "Ispar koi tax nahi hota",
            "c": "Ispar monthly interest milta hai",
            "d": "Ye interest-free loan deta hai"
        },
        "correct_option": "a",
        "explanation": "PMEX SECP regulated exchange hai jahan aap physically gold liye baghair uski digital ownership aur trade kar sakte hain."
    },
    {
        "id": 218,
        "level": 82,
        "question": "Commercial real estate (shops, offices) residential (houses, flats) se aam tor par kaise behtar hai?",
        "options": {
            "a": "Iski safai asan hoti hai",
            "b": "Iski rental yield (aam tor par 6% - 9%) residential (3% - 5%) se behtar hoti hai",
            "c": "Ispar tax nahi lagta",
            "d": "Iski resale fori ho jati hai"
        },
        "correct_option": "b",
        "explanation": "Commercial properties ki rental demand aur yields residential sector ke muqable mein behtar hoti hain."
    },
    {
        "id": 219,
        "level": 82,
        "question": "Gold Bullion (بلین) ka kya matlab hota hai?",
        "options": {
            "a": "Gold ki jewelry",
            "b": "High purity gold bars ya standard gold coins",
            "c": "Ghair-khalis sona",
            "d": "White gold"
        },
        "correct_option": "b",
        "explanation": "Bullion ka matlab standard, high purity (99.5%+) gold ya silver bars aur coins hote hain jo trade ke liye use hote hain."
    },
    {
        "id": 220,
        "level": 82,
        "question": "Real Estate investment ka sab se bara draw-back ya rukawat kya hai?",
        "options": {
            "a": "Ispar zaroorat se zyada profit milta hai",
            "b": "High initial capital required (bari sarmayakari ki zaroorat hoti hai)",
            "c": "Ye illegal hota hai",
            "d": "Iska rate kabhi barhta nahi"
        },
        "correct_option": "b",
        "explanation": "Real estate mein enter hone ke liye bari rakam (capital) chahiye hoti hai jo aam small savers ke paas nahi hoi."
    },
    {
        "id": 221,
        "level": 10,
        "question": "Voluntary Pension Scheme (VPS) kis idare se registered aur regulate hoti hai?",
        "options": {
            "a": "FBR",
            "b": "SECP (Securities and Exchange Commission of Pakistan)",
            "c": "State Bank of Pakistan",
        ...
        "correct_option": "b",
        "explanation": "VPS retirement funds hote hain jo SECP se registered asset management companies manage karti hain."
    },
    {
        "id": 222,
        "level": 10,
        "question": "VPS mein investment karne par Income Tax Ordinance ke kis Section ke tehat tax credit milta hai?",
        "options": {
            "a": "Section 61",
            "b": "Section 63 (Pension Funds tax rebate)",
            "c": "Section 62",
            "d": "Section 114"
        },
        "correct_option": "b",
        "explanation": "Section 63 ke tehat retirement/pension schemes mein invest karne par up to 20% tax credit haasil kiya ja sakta hai."
    },
    {
        "id": 223,
        "level": 10,
        "question": "Retirement portfolio se withdrawals ke liye '4% Rule' ka kya maqsad hai?",
        "options": {
            "a": "Ye batata hai ke har saal portfolio ka 4% tax dena hoga",
            "b": "Ye safe withdrawal rate hai jo ensure karta hai ke retirement ke doran aap ka capital khatam na ho",
            "c": "Ye batata hai ke monthly return 4% mile ga",
            "d": "Ipar 4% interest charge hota hai"
        },
        "correct_option": "b",
        "explanation": "4% rule ke mutabiq agar aap retirement portfolio se har saal 4% nikalte hain, toh inflation ke bawajood aap ka fund lambe arsay tak chalta hai."
    },
    {
        "id": 224,
        "level": 10,
        "question": "Shariah-compliant pension funds kis kisam ke assets mein invest karte hain?",
        "options": {
            "a": "Conventional bank deposits aur corporate bonds",
            "b": "Sood se paak Government Sukuk, Islamic savings, aur Shariah-compliant equity stocks",
            "c": "Prize bonds aur gambling platforms",
            "d": "Foreign currency instruments"
        },
        "correct_option": "b",
        "explanation": "Islamic pension funds strict Shariah guidelines ke tehat sood se pak equity stocks aur Sukuk bonds mein invest karte hain."
    },
    {
        "id": 225,
        "level": 10,
        "question": "'Rule of 25' ke mutabiq comfortable retirement ke liye aap ka target fund kitna hona chahiye?",
        "options": {
            "a": "Aap ki age ka 25 times",
            "b": "Aap ke saalana expenses (expenses) ka 25 times",
            "c": "25 lakh rupees",
            "d": "Aap ki basic income ka 25%"
        },
        "correct_option": "b",
        "explanation": "Rule of 25 ke mutabiq agar aap ke paas apne saalana kharche ka 25 guna capital mehfooz hai, toh aap retirement le sakte hain."
    },
    {
        "id": 226,
        "level": 10,
        "question": "Islamic Will ko Arabic aur Urdu mein kya kaha jata hai?",
        "options": {
            "a": "Takaful",
            "b": "Wasiyat (وصیت)",
            "c": "Qard",
        ...
        "correct_option": "b",
        "explanation": "Apni death ke baad assets ki legacy transition ke liye jo legal/religious document banaya jata hai use Wasiyat kehte hain."
    },
    {
        "id": 227,
        "level": 10,
        "question": "Shariah rules ke mutabiq ek shakhs maximum kitna hissa Wasiyat ke zariye ghair-waris ko de sakta hai?",
        "options": {
            "a": "Aadhaa (1/2) capital",
            "b": "Ek tihai (1/3) wealth",
            "c": "Poora (100%) sarmaya",
            "d": "Kuch bhi nahi de sakta"
        },
        "correct_option": "b",
        "explanation": "Islami qanoon ke mutabiq aap maximum 1/3 wealth ghair-waris ya charity ko wasiyat kar sakte hain. Baki 2/3 shari'i warisaan mein distribute hota hai."
    },
    {
        "id": 228,
        "level": 10,
        "question": "Wasiyat ke 1/3 hisse ke ilawa baqi 2/3 wealth shari'i warison mein kis rule ke tehat taqseem hoti hai?",
        "options": {
            "a": "Sarkari tax rules ke mutabiq",
            "b": "Shariah inheritance laws (وراثت کے اسلامی قوانین) ke tehat",
            "c": "Complete equal sharing formula par",
            "d": "Sirf baray bete ko di jati hai"
        },
        "correct_option": "b",
        "explanation": "Wasiyat ke ilawa baqi assets automatically Shariah compliance rules ke mutabiq shari'i warisaan (parents, spouse, children) mein fix ratios ke tehat taqseem hote hain."
    },
    {
        "id": 229,
        "level": 10,
        "question": "Voluntary Pension Scheme (VPS) mein kya sarmayakar ko pension manager badalne ki ijazat hoti hai?",
        "options": {
            "a": "Nahi, fund manager fix rehta hai",
            "b": "Haan, sarmayakar jab chahe apna fund balance dusre AMC (Pension Manager) mein baghair kisi penalty ke transfer kar sakta hai",
            "c": "Sirf retirement age par ijazat hoti hai",
            "d": "Is transfer par 50% tax deduct hota hai"
        },
        "correct_option": "b",
        "explanation": "SECP rules ke mutabiq VPS accounts flexible hote hain aur aap manager ki performance dekh kar fund switch kar sakta hai."
    },
    {
        "id": 230,
        "level": 10,
        "question": "Retirement portfolio mein age barhne ke sath asset allocation mein stocks (equities) ka ratio kaisa hona chahiye?",
        "options": {
            "a": "Stocks barhane chahiye",
            "b": "Stocks ka ratio kam aur low-risk debt/fixed income products barhane chahiye",
            "c": "Dono barabar rakhne chahiye",
            "d": "Retirement portfolio mein stocks nahi hone chahiye"
        },
        "correct_option": "b",
        "explanation": "Jaise jaise retirement qareeb ho risk appetite kam hoti hai, isliye safe/fixed-income products barhane chahiye taake capital loss na ho."
    },
    {
        "id": 231,
        "level": 10,
        "question": "Islamic Takaful pension plans conventional annuity plans se kaise behtar hain?",
        "options": {
            "a": "In mein high interest profit milta hai",
            "b": "Ye sood aur ghair-shari'i investments se paak aur mutual co-operation par mabni hote hain",
            "c": "In mein tax nahi dena parta",
            "d": "In ka profit government guaranteed hota hai"
        },
        "correct_option": "b",
        "explanation": "Takaful plans Shariah compliant hotey hain aur inka pension pool purely halal/Shariah approved assets mein invest kiya jata hai."
    },
    {
        "id": 232,
        "level": 10,
        "question": "Retirement key context mein Annuity (اینویٹی) product ka kya matlab hai?",
        "options": {
            "a": "Retirement par lump-sum amount withdraw karna",
            "b": "Retirement fund se regular, periodic monthly payouts (pension) haasil karna",
            "c": "Bina return ke donation dena",
            "d": "Life insurance plan"
        },
        "correct_option": "b",
        "explanation": "Annuity ka matlab ek contract hota hai jahan retirement pool ko convert karke monthly salary ya regular pension haasil ki jati hai."
    },
    {
        "id": 233,
        "level": 10,
        "question": "Shariah inheritance rule ke mutabiq shohar ki death par bewa (wife) ka share kitna hota hai agar unki aulad (children) ho?",
        "options": {
            "a": "Aadhaa (50%) share",
            "b": "Aathwan hissa (1/8 یا 12.5%)",
            "c": "Chothai (1/4)",
            "d": "Wife ko share nahi milta"
        },
        "correct_option": "b",
        "explanation": "Aulad ki majoodgi mein bewa ka share shohar ke baqi chorey huay assets ka 1/8 (12.5%) hota hai."
    },
    {
        "id": 234,
        "level": 10,
        "question": "Shohar ki death par bewa (wife) ka share kitna hota hai agar unki koi aulad na ho?",
        "options": {
            "a": "Aathwan hissa (1/8)",
            "b": "Chothai (1/4 یا 25%)",
            "c": "Aadhaa (1/2)",
        ...
        "correct_option": "b",
        "explanation": "Shohar ki death par agar unki aulad na ho toh wife ka share assets ka 1/4 (25%) hota hai."
    },
    {
        "id": 235,
        "level": 10,
        "question": "Retirement planning shuru karne ka optimal time kab hota hai?",
        "options": {
            "a": "55 saal ki umar mein",
            "b": "Pehli salary aane ke sath career ke aghaaz mein",
            "c": "Government job se retirement ke baad",
            "d": "Bachon ki shadi ke baad"
        },
        "correct_option": "b",
        "explanation": "Retirement portfolio jitna jaldi shuru hoga compounding ko utna zyada time milega, aur monthly investment bojh nahi banegi."
    },
    {
        "id": 236,
        "level": 10,
        "question": "Inflation retirement savings ko kis tarah tabah karti hai?",
        "options": {
            "a": "Ye savings par tax barha deti hai",
            "b": "Ye money key purchasing power ko kam karke monthly monthly income ki real value ko ghatati hai",
            "c": "Ye fund manager ko chori karne ki ijazat deti hai",
            "d": "Iska savings par koi asar nahi hota"
        },
        "correct_option": "b",
        "explanation": "Agar retirement ke bad aap ko fixed 50,000 monthly mil rahe hain, toh 15% annual inflation se kuch saal baad us 50,000 ki buying power adhi reh jaye gi."
    },
    {
        "id": 237,
        "level": 10,
        "question": "Voluntary Pension Scheme (VPS) se retirement age (aam tor par 60) se pehle balance withdraw karne par kya hota hai?",
        "options": {
            "a": "Withdrawal mukammal block hoti hai",
            "b": "Withholding tax deduct hota hai jo tax credits haasil kiye gaye thay unki recovery ke liye",
            "c": "Zero tax lagta hai",
            "d": "Double profit diya jata hai"
        },
        "correct_option": "b",
        "explanation": "VPS long-term retirement lock-in ke liye hai, pehle nikalne par tax rebate recover karne ke liye withholding tax lagta hai."
    },
    {
        "id": 238,
        "level": 10,
        "question": "Legacy/Estate planning ka primary objective kya hota hai?",
        "options": {
            "a": "Zakat se bachna",
            "b": "Wealth transition ko asan banana aur legal disputes/conflicts se bachana",
            "c": "FBR tax bachana",
            "d": "Banks se loan lena"
        },
        "correct_option": "b",
        "explanation": "Wills aur properly structured assets hone se family members ke darmiyan inheritance conflicts nahi hotay aur wealth smooth hand-over hoti hai."
    },
    {
        "id": 239,
        "level": 10,
        "question": "Pension Fund Manager ka core role kya hota hai?",
        "options": {
            "a": "Borrowers ko loan dena",
            "b": "Pension pool capital ko equity aur bonds mein safety ke sath invest karna",
            "c": "Government budget banana",
            "d": "Banks run karna"
        },
        "correct_option": "b",
        "explanation": "Fund manager sarmayakaron ki equity, debt, aur money market sub-funds mein allocation manage karta hai taake risk balanced rahe."
    },
    {
        "id": 240,
        "level": 10,
        "question": "Wealth Preservation in retirement ka kya matlab hai?",
        "options": {
            "a": "Aggressive stocks mein invest karna",
            "b": "Capital loss se bachna aur portfolio yields ko inflation-proof banana",
            "c": "Ghar in cash jamah karna",
            "d": "Gold sell kar dena"
        },
        "correct_option": "b",
        "explanation": "Retirement ke doran savings ko risk-exposed assets se bacha kar capital reserve rakhna aur yields se monthly consumption poori karna wealth preservation hai."
    }
]
